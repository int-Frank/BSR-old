...
//  //-----------------------------------------------------------------------------------------------
//
//  Ref<Material> Material::Create(Ref<Shader> const & a_shader)
//  {
//    return Ref<Material>( new Material(a_shader));
//  }
//
//  Material::Material(Ref<Shader> const & a_shader)
//    : m_shader(a_shader)
//  {
//    //TODO since we don't allow callbacks from other threads, this needs to be a command message.
//    //Or maybe we don't need this, as the result of the shader relod will be stored in RenderThreadData
