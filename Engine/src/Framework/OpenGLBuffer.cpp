...
namespace Engine 
{
  ...
  public:
    ...
    void Init(void* data, uint32_t size, VertexBufferUsage usage = VertexBufferUsage::Static) override;
    void Init(uint32_t size, VertexBufferUsage usage = VertexBufferUsage::Dynamic) override;
